...
<br/>The first will need to be added to the &lt;types&gt; element and the second to the &lt;fields&gt; element.  Where these sections are in your schema.xml file will vary depending on which version of Solr you're using.
